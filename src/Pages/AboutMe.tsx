...
const AboutMe = () => {
  return (
    <a href="about-me" className="w-full h-full">
      <div className="uppercase cursor-default">
        ...
        <div className="text-[5.7rem] tracking-[7px] leading-[8rem]">
          <div className="flex justify-start items-center gap-10">
            ...
            <div className="flex justify-center items-center max-w-[16rem] w-full h-[4.6rem] rounded-full bg-secondary gap-3 gradient-background-button dark:btn dark:btn-gradient-border dark:btn-glow">
              <p
        ...
        <div className={`${separatorLineStyles}`}></div>
