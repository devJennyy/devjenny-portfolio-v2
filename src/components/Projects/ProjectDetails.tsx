...
const ProjectDetails = ({ data }: Props) => {
  ...
  return (
    <div className="flex flex-col items-center w-full pt-14 pb-16 gap-6">
      ...
      <div className="max-w-[39rem] w-full text-center text-primary/50 dark:text-primaryDark/70 mt-2">
        <p>
          Here are the top 5 features of the web application. To explore the full project, feel free to visit my
          <a
            target="_blank"
          ...
          , or check out the complete design on
          <a
            target="_blank"
            href={data.figmaLink}
            className={`text-secondary dark:${gradientTextStyles} font-medium ml-1 hover:underline-offset-4 hover:underline cursor-pointer`}
